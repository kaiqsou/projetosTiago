...
class Node
{
    constructor(value)
    {
        ...
        this.left = null;   // referencia para o nó filho à esquerda
        this.right = null;  // referencia para o nó filho à direita
    }
}
...
class BinaryTree 
{
    constructor()
    {
        this.root = null;   // a raiz é null pela arvore estar inicialmente vazia 
    }
    ...
    insert(value)
    {
        ...
        if (this.root === null)
        {
            // Se a árvore estiver vazia, o novo nó se torna a raíz
            this.root = newNode;
        }
        else
        {
    ...
    _insertNode(node, newNode)
    {
        ...
        {   
            ...
            if (node.left === null)
            {
                // Caso não haja nó na esquerda, insere o novo nó aqui
                node.left = newNode;
            } 
            else
            {
        ...
        else
        {
            ...
            if (node.right === null)
            {
                // Caso não haja nó na direita, insere o novo nó aqui
                node.right = newNode;
            }
            else
            {
    ...
    postOrder(node = this.root)
    {
        if (node !== null)
        {
            ...
            console.log(value);             // Visita o nó atual
        }
    }
    ...
    search(value)
    {
        return this._searchNode(this.root, value);  // Inicia a busca a partir da raíz
    }
    ...
    _searchNode(node, value)
    {
        ...
        {
            // Se o valor buscado é menor, continua a busca na subárvore esquerda
            return this._searchNode(node.left, value);
        }
        else
        {
            // Se o valor buscado é maior, continua a busca na subárvore direita
